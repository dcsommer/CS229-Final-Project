    ...
    \begin{column}{.3\linewidth}
      ...
      %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
       ...
       \begin{block}{Model Definitions}
          ...
          separate out the possible spikes to cluster. We \alert{define the
          ...
          $\alpha = 15$ from each other. To form a single feature vector $X^{(i)}$ we \alert{take the
...
\end{columns} 
      ...
      \begin{block}{Results}
        Plotting the top 3 clusters for both ICA(left)
        vs. Polynomial(right) using g-means:
        \begin{columns}[t]
          \column{.48\linewidth}
          \begin{center}
          \includegraphics[width=0.6\linewidth]{images/top3_pca.png} \\
          110 Clusters were found
          \end{center}
          \column{.48\linewidth}
          \begin{center}
          \includegraphics[width=0.6\linewidth]{images/top3_poly2.png} \\
          120 Clusters were found
          \end{center}
        \end{columns}
        \end{block}
       ...
       \begin{block}{Conclusion}
        ...
        \begin{itemize}
        \item PCA was very useful for \alert{compressing} the data well
        \item Understanding meaning of data and how to \alert{format it
          correctly} is important
        \item The number of clusters and the confidence of them is
          very \alert{dependent on the heuristic} used.
        \end{itemize}
