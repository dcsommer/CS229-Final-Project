...
\title{\huge Link Prediction in Email Exchange Network}
\author{David Brody, Roy Frostig, David Tobin}
\institute[Stanford Univeristy]{Department of Computer Science,
  Stanford University, Stanford, California}
\date[Mar. 17th, 2011]{Mar. 17th, 2011}
        ...
        \begin{minipage}[T]{.95\textwidth}  % tweaks the width, makes a new \textwidth
          \parbox[t][\columnheight]{\textwidth}{ % must be some better way to set the the height, width and textwidth simultaneously
            ...
            \begin{block}{Introduction}
              ...
              predicting future communications in a social network
              ...
              \begin{itemize}
               ...
               \item We propose:
                 \begin{itemize}
                   \item Feature extraction to classify nodes
                   \item Learn parameters for activity between classes
                   \item Allow for nontrivial influence between nodes
                     and activity
